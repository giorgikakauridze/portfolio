      ...
      <div>
        <div className="ml-36 mobile:m-0 mr-36 pt-36 flex gap-5 justify-between">
          ...
          <p className="text-xl w-[50%] mobile:text-xs font-[1000]">
            ...
            blog offers valuable information on topics ranging from market
            trends to the most secure crypto strategies. Discover tips, tools,
            and techniques to help you make informed decisions in the
